...
| Register                                             | Address                                   |
+======================================================+===========================================+
| :ref:`USER_IRQ_4_IN <USER_IRQ_4_IN>`                 | :ref:`0xc8008800 <USER_IRQ_4_IN>`         |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_4_MODE <USER_IRQ_4_MODE>`             | :ref:`0xc8008804 <USER_IRQ_4_MODE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_4_EDGE <USER_IRQ_4_EDGE>`             | :ref:`0xc8008808 <USER_IRQ_4_EDGE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_4_EV_STATUS <USER_IRQ_4_EV_STATUS>`   | :ref:`0xc800880c <USER_IRQ_4_EV_STATUS>`  |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_4_EV_PENDING <USER_IRQ_4_EV_PENDING>` | :ref:`0xc8008810 <USER_IRQ_4_EV_PENDING>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_4_EV_ENABLE <USER_IRQ_4_EV_ENABLE>`   | :ref:`0xc8008814 <USER_IRQ_4_EV_ENABLE>`  |
+------------------------------------------------------+-------------------------------------------+

USER_IRQ_4_IN
^^^^^^^^^^^^^

`Address: 0xc8008800 + 0x0 = 0xc8008800`
...
`Address: 0xc8008800 + 0x4 = 0xc8008804`
...
`Address: 0xc8008800 + 0x8 = 0xc8008808`
...
`Address: 0xc8008800 + 0xc = 0xc800880c`
...
`Address: 0xc8008800 + 0x10 = 0xc8008810`
...
`Address: 0xc8008800 + 0x14 = 0xc8008814`
