...
| Register                                             | Address                                   |
+======================================================+===========================================+
| :ref:`USER_IRQ_2_IN <USER_IRQ_2_IN>`                 | :ref:`0xc8007800 <USER_IRQ_2_IN>`         |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_2_MODE <USER_IRQ_2_MODE>`             | :ref:`0xc8007804 <USER_IRQ_2_MODE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_2_EDGE <USER_IRQ_2_EDGE>`             | :ref:`0xc8007808 <USER_IRQ_2_EDGE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_2_EV_STATUS <USER_IRQ_2_EV_STATUS>`   | :ref:`0xc800780c <USER_IRQ_2_EV_STATUS>`  |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_2_EV_PENDING <USER_IRQ_2_EV_PENDING>` | :ref:`0xc8007810 <USER_IRQ_2_EV_PENDING>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_2_EV_ENABLE <USER_IRQ_2_EV_ENABLE>`   | :ref:`0xc8007814 <USER_IRQ_2_EV_ENABLE>`  |
+------------------------------------------------------+-------------------------------------------+

USER_IRQ_2_IN
^^^^^^^^^^^^^

`Address: 0xc8007800 + 0x0 = 0xc8007800`
...
`Address: 0xc8007800 + 0x4 = 0xc8007804`
...
`Address: 0xc8007800 + 0x8 = 0xc8007808`
...
`Address: 0xc8007800 + 0xc = 0xc800780c`
...
`Address: 0xc8007800 + 0x10 = 0xc8007810`
...
`Address: 0xc8007800 + 0x14 = 0xc8007814`
