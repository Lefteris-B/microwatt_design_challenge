...
| Register                                             | Address                                   |
+======================================================+===========================================+
| :ref:`USER_IRQ_0_IN <USER_IRQ_0_IN>`                 | :ref:`0xc8006800 <USER_IRQ_0_IN>`         |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_0_MODE <USER_IRQ_0_MODE>`             | :ref:`0xc8006804 <USER_IRQ_0_MODE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_0_EDGE <USER_IRQ_0_EDGE>`             | :ref:`0xc8006808 <USER_IRQ_0_EDGE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_0_EV_STATUS <USER_IRQ_0_EV_STATUS>`   | :ref:`0xc800680c <USER_IRQ_0_EV_STATUS>`  |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_0_EV_PENDING <USER_IRQ_0_EV_PENDING>` | :ref:`0xc8006810 <USER_IRQ_0_EV_PENDING>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_0_EV_ENABLE <USER_IRQ_0_EV_ENABLE>`   | :ref:`0xc8006814 <USER_IRQ_0_EV_ENABLE>`  |
+------------------------------------------------------+-------------------------------------------+

USER_IRQ_0_IN
^^^^^^^^^^^^^

`Address: 0xc8006800 + 0x0 = 0xc8006800`
...
`Address: 0xc8006800 + 0x4 = 0xc8006804`
...
`Address: 0xc8006800 + 0x8 = 0xc8006808`
...
`Address: 0xc8006800 + 0xc = 0xc800680c`
...
`Address: 0xc8006800 + 0x10 = 0xc8006810`
...
`Address: 0xc8006800 + 0x14 = 0xc8006814`
