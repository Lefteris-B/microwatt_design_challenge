...
`define USER_PROJECT_ID 32'h2511_1312 
...
// ============================================================================
// Microwatt SoC GPIO Configuration
// ============================================================================
// GPIO 5:  UART TX (output from Microwatt)
// GPIO 6:  UART RX (input to Microwatt)
// GPIO 7-37: Unused (directly active set as inputs)
// ============================================================================

`define USER_CONFIG_GPIO_5_INIT  `GPIO_MODE_USER_STD_OUTPUT         // UART TX
`define USER_CONFIG_GPIO_6_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL   // UART RX
