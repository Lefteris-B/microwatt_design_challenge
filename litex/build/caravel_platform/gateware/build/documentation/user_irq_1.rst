...
| Register                                             | Address                                   |
+======================================================+===========================================+
| :ref:`USER_IRQ_1_IN <USER_IRQ_1_IN>`                 | :ref:`0xc8007000 <USER_IRQ_1_IN>`         |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_1_MODE <USER_IRQ_1_MODE>`             | :ref:`0xc8007004 <USER_IRQ_1_MODE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_1_EDGE <USER_IRQ_1_EDGE>`             | :ref:`0xc8007008 <USER_IRQ_1_EDGE>`       |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_1_EV_STATUS <USER_IRQ_1_EV_STATUS>`   | :ref:`0xc800700c <USER_IRQ_1_EV_STATUS>`  |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_1_EV_PENDING <USER_IRQ_1_EV_PENDING>` | :ref:`0xc8007010 <USER_IRQ_1_EV_PENDING>` |
+------------------------------------------------------+-------------------------------------------+
| :ref:`USER_IRQ_1_EV_ENABLE <USER_IRQ_1_EV_ENABLE>`   | :ref:`0xc8007014 <USER_IRQ_1_EV_ENABLE>`  |
+------------------------------------------------------+-------------------------------------------+

USER_IRQ_1_IN
^^^^^^^^^^^^^

`Address: 0xc8007000 + 0x0 = 0xc8007000`
...
`Address: 0xc8007000 + 0x4 = 0xc8007004`
...
`Address: 0xc8007000 + 0x8 = 0xc8007008`
...
`Address: 0xc8007000 + 0xc = 0xc800700c`
...
`Address: 0xc8007000 + 0x10 = 0xc8007010`
...
`Address: 0xc8007000 + 0x14 = 0xc8007014`
